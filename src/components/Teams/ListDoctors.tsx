...
const ListDoctors: React.FC = () => {
  ...
  return (
    <div className="section_list_doctors">
      <Button onClick={() => addDoctor(2, "Dr. Gregory House", "Internista", "Médico especialista en medicina interna", "https://www.lanacion.com.ar/resizer/v2/dr-VGT2DJVTCFHVXA5DCJWF6F7L5Y.jpg?auth=6744d4e14c7d06fc09def55b0ded72e7aba5bc63c8393aec488a6dd7bc97a678&width=880&height=586&quality=70&smart=true")}>Agregar Doctor</Button>
      <Row gutter={[16, 16]}>
        {doctors.map((doctor) => (
